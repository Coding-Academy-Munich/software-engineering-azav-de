...
# %%
tongue_twister.find("wood")

# %%
tongue_twister.replace("wood", "coffee")
...
# %%
re.search("coffee", tongue_twister)

# %%
re.search("coffee", tongue_twister) is None
...
# %%
re.findall("chuck", tongue_twister)

# %%
re.findall("coffee", tongue_twister)
...
# %%
for match in re.finditer("wood", tongue_twister):
...
# %%
def find_word_positions(text: str, word: str) -> list:
