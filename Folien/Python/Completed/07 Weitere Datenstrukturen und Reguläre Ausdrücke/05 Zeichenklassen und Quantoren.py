...
# %%
re.findall(r"w..d", tongue_twister)

# %%
re.findall(r"c..ck", tongue_twister)
...
# %%
re.findall(r"\w*wood\w*", tongue_twister)
...
# %%
re.findall(r"colou?r", "American color and British colour")

# %%
re.findall(r"https?://", "http://example.com and https://secure.com")
...
# %%
re.findall(r"\b\w{4}\b", tongue_twister)

# %%
re.findall(r"\b\w{1,4}\b", tongue_twister)

# %%
re.findall(r"\b\w{5,}\b", tongue_twister)
...
# %%
re.findall(r"\d{3,}", "Anrufen: 42, 123 oder 98765")

# %%
re.findall(r"[aeiou]{2}", tongue_twister)

# %%
re.findall(r"[A-Z][a-z]+", "Hello World, Good Morning")
